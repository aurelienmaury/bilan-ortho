...
<html>
	...
	<body>
		<a href="#create-domaineOrtho" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-domaineOrtho" class="content scaffold-create" role="main">

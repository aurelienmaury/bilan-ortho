...
<html>
	...
	<body>
		<a href="#edit-domaineOrtho" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-domaineOrtho" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${domaineOrthoInstance?.version}" />
				<fieldset class="form">

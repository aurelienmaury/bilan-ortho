...
<html>
	...
	<body>
		<a href="#list-domaineOrtho" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-domaineOrtho" class="content scaffold-list" role="main">
			...
			<table>
				...
				<g:each in="${domaineOrthoInstanceList}" status="i" var="domaineOrthoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${domaineOrthoInstance.id}">${fieldValue(bean: domaineOrthoInstance, field: "nom")}</g:link></td>
